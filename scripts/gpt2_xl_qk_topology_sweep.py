...
def main() -> None:
    ...
    print(
        f"{'name':<28} {'sites/blk':>10} {'ddp/blk':>8} {'n_lw':>5} {'n_ci':>5} {'n_pp':>5} {'total':>6}"
    )
    print("-" * 80)
    for t in TOPOLOGIES:
        print(
            f"{t.name:<28} {t.sites_per_block:>10} {t.ddp_per_block:>8} {t.n_lw_ranks:>5} {t.n_ci:>5} {t.n_ppgd:>5} {t.total_ranks:>6}"
        )
    print()
