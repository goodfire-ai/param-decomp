...
def main() -> None:
    ...
    print(f"  one fwd (ref)  : {one_fwd / 1e12:8.1f} TFLOP  → step = {step_flops / one_fwd:.2f}× one forward")
    ...
    print(f">>> step does {step_flops / one_fwd:.1f}× one forward's FLOPs; the ckpt recompute "
