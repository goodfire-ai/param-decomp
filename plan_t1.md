...
- **Baseline being regenerated:** `p-20f9fc15` (job 644450, 16 GPUs) re-runs the 4L config on current
  ...
  `no_beta` row are pending** — fill them from `p-20f9fc15` once available. Predecessor `p-5b17949e`
  stays cached for the other metrics' reference values.
