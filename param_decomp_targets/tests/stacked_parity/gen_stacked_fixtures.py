...
restructured away. Regenerate from a base-branch checkout, e.g.:
    ...
    <base-checkout>/.venv/bin/python \
        param_decomp/tests/stacked_parity/gen_stacked_fixtures.py
...
from param_decomp.adversary import (  # noqa: E402
...
from param_decomp_targets.llama8b import (  # noqa: E402
    KINDS,
    LayerRange,
    init_decomp_vu,
    llama_decomposed_lm,
...
from param_decomp_targets.tests.test_llama8b import _tiny_cfg, _tiny_target  # noqa: E402
