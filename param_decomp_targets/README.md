...
sees only the `DecomposedModel` protocol (`param_decomp.model`) and the `ArchFamily`
grammar contract (`param_decomp.family`). The lab composes: the model-name → family
