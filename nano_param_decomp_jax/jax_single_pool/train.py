    ...
    def step(state: TrainState, frozen: Any, residual: Float[Array, "b t d"], key: PRNGKeyArray):
        ...
        for term_idx, term in enumerate(recon_terms):
            ...
            for entry_idx, entry in enumerate(term.plan):
                ...
                def ascent_loss(sources: dict[str, Array], entry=entry, routes=routes_per_draw):
                ...
                def sign_ascend_body(
                    sources: dict[str, Array], _: None, ascent_loss=ascent_loss
        ...
        def loss_fn(trainable: tuple[Any, CIFn, dict[str, dict[str, Array]]]):
