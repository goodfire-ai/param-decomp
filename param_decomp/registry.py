...
EXPERIMENT_REGISTRY: dict[str, ExperimentConfig] = {
    ...
    "ss_llama_simple": ExperimentConfig(
        ...
        config_path=Path("param_decomp/experiments/lm/ss_llama_simple_config.yaml"),
        expected_runtime=2000,
    ),
    "ss_llama_simple-1L": ExperimentConfig(
        task_name="lm",
        decomp_script=Path("param_decomp/experiments/lm/lm_decomposition.py"),
        config_path=Path("param_decomp/experiments/lm/ss_llama_simple-1L.yaml"),
        expected_runtime=180,
    ),
    "ss_llama_simple-2L": ExperimentConfig(
        task_name="lm",
        decomp_script=Path("param_decomp/experiments/lm/lm_decomposition.py"),
        config_path=Path("param_decomp/experiments/lm/ss_llama_simple-2L.yaml"),
        expected_runtime=240,
    ),
    "ss_gpt2": ExperimentConfig(
        task_name="lm",
        decomp_script=Path("param_decomp/experiments/lm/lm_decomposition.py"),
        config_path=Path("param_decomp/experiments/lm/ss_gpt2_config.yaml"),
        expected_runtime=60,
    ),
    "gpt2": ExperimentConfig(
        task_name="lm",
        decomp_script=Path("param_decomp/experiments/lm/lm_decomposition.py"),
        config_path=Path("param_decomp/experiments/lm/gpt2_config.yaml"),
        expected_runtime=60,
    ),
    "ss_gpt2_simple": ExperimentConfig(
        task_name="lm",
        decomp_script=Path("param_decomp/experiments/lm/lm_decomposition.py"),
        config_path=Path("param_decomp/experiments/lm/ss_gpt2_simple_config.yaml"),
        expected_runtime=330,
    ),
    "ss_gpt2_simple_noln": ExperimentConfig(
        task_name="lm",
        decomp_script=Path("param_decomp/experiments/lm/lm_decomposition.py"),
        config_path=Path("param_decomp/experiments/lm/ss_gpt2_simple_noln_config.yaml"),
        expected_runtime=330,
    ),
    "ss_gpt2_simple-1L": ExperimentConfig(
        task_name="lm",
        decomp_script=Path("param_decomp/experiments/lm/lm_decomposition.py"),
        config_path=Path("param_decomp/experiments/lm/ss_gpt2_simple-1L.yaml"),
        expected_runtime=180,
    ),
    "ss_gpt2_simple-2L": ExperimentConfig(
        task_name="lm",
        decomp_script=Path("param_decomp/experiments/lm/lm_decomposition.py"),
        config_path=Path("param_decomp/experiments/lm/ss_gpt2_simple-2L.yaml"),
        expected_runtime=240,
    ),
    "ss_llama_simple_mlp-1L": ExperimentConfig(
        task_name="lm",
        decomp_script=Path("param_decomp/experiments/lm/lm_decomposition.py"),
        config_path=Path("param_decomp/experiments/lm/ss_llama_simple_mlp-1L.yaml"),
        expected_runtime=180,
    ),
    ...
    "ss_llama_simple_mlp-2L-wide": ExperimentConfig(
        task_name="lm",
        decomp_script=Path("param_decomp/experiments/lm/lm_decomposition.py"),
        config_path=Path("param_decomp/experiments/lm/ss_llama_simple_mlp-2L-wide.yaml"),
        expected_runtime=1600,
    ),
    "ss_llama_simple_mlp": ExperimentConfig(
        task_name="lm",
        decomp_script=Path("param_decomp/experiments/lm/lm_decomposition.py"),
        config_path=Path("param_decomp/experiments/lm/ss_llama_simple_mlp.yaml"),
        expected_runtime=1600,
    ),
    "ts": ExperimentConfig(
        task_name="lm",
        decomp_script=Path("param_decomp/experiments/lm/lm_decomposition.py"),
        config_path=Path("param_decomp/experiments/lm/ts_config.yaml"),
        expected_runtime=120,
    ),
    "pile_llama_simple_mlp-2L": ExperimentConfig(
        task_name="lm",
        decomp_script=Path("param_decomp/experiments/lm/lm_decomposition.py"),
        config_path=Path("param_decomp/experiments/lm/pile_llama_simple_mlp-2L.yaml"),
