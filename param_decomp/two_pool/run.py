...
from param_decomp.configs import LoggingConfig, ScheduleConfig
    ...
    *,
    ...
    with profiler_ctx:
        for step in range(n_steps):
            ...
            # --- Train logging (mirrors run_pd.optimize's cadence) ---
            if sink is not None and logging_config is not None:
                if step % logging_config.train_log_freq == 0:
                    ...
                    if layout.my_rank == 0 and combined is not None:
                        ...
                        sink.log(combined, step=step, section="train")
