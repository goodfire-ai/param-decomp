...
def test_llama_site_specs_dims():
    ...
    assert partitions["layers.2.self_attn.q_proj"] == AttentionHeads(cfg.n_head)
    assert partitions["layers.2.self_attn.k_proj"] == AttentionHeads(cfg.n_kv_head)
    assert partitions["layers.2.self_attn.v_proj"] == AttentionHeads(cfg.n_kv_head)
    assert (
