...
| `component_norm.py` | EXPERIMENTAL Muon-style components optimizer (`type: component_norm`, SPEC S20 amendment 2026-07-14): optional Nesterov momentum → per-subcomponent normalization of the induced rank-≤2 weight update `dW_c = gV_c ⊗ U_c + V_c ⊗ gU_c` (closed-form 2×2 frobenius/spectral, no SVD) → scheduled LR, no global clip |
