...
torch-free; run it in a throwaway venv, like the `param_decomp/tests/targets/equivalence/` torch generators):
    ...
    /tmp/qwen3-golden/bin/python param_decomp/tests/targets/qwen3_hf_parity/gen_hf_fixtures.py         # tiny
    /tmp/qwen3-golden/bin/python param_decomp/tests/targets/qwen3_hf_parity/gen_hf_fixtures.py --real  # 8B
