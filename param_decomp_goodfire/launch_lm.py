...
def _submit_slurm(
    ...
    *,
    ...
    (pinned launch config + `.env`), and sbatch across `dp // gpus_per_node` whole nodes
    (divisibility is the schema's `validate_launch_topology` claim)."""
    gpn = cfg.runtime.gpus_per_node
    nodes = cfg.runtime.dp // gpn
