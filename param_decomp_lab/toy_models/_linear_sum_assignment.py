...
#
# This is a vendored copy of scipy.optimize.linear_sum_assignment to avoid
# requiring the entire scipy package as a dependency.
#
# Original implementation history:
# - Hungarian algorithm (Kuhn-Munkres) for solving the linear sum assignment problem
# - Originally from scikit-learn
...
def _step1(state):
    ...
    # in the matrix.
    for i, j in zip(*np.where(state.C == 0), strict=False):
