...
Usage:
    python -m param_decomp_lab.dataset_attributions.scripts.run_merge --wandb_path <path> --subrun_id da-xxx
"""
...
def get_command(wandb_path: str, subrun_id: str) -> str:
    return (
        f"python -m param_decomp_lab.dataset_attributions.scripts.run_merge "
