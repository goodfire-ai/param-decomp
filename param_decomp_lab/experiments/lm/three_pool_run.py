...
THREE_POOL_SLURM_ENV: dict[str, str] = {
    ...
    # TEMP diagnostics for the silent-hang investigation (revert after). PD_TRACE emits
    # the per-step heartbeat + step_pool_a cross-pool phase traces from a few ranks; the
    # TORCH_NCCL_* knobs make a collective hang dump its flight recorder on timeout.
    "PD_TRACE": "1",
    "PD_TRACE_RANKS": "0,16,79",
