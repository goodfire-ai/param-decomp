...
export XLA_FLAGS="--xla_gpu_enable_command_buffer= --xla_gpu_autotune_level=0 --xla_dump_to=/mnt/data/artifacts/mechanisms/param-decomp/reshard_hlo3 --xla_dump_hlo_as_text"
