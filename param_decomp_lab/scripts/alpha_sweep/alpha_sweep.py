...
def run_r_sweep(
    ...
    data = pd_run.data_cfg
    assert isinstance(data, LMDataConfig)
    ...
    # No saved eval_batch_size — the YAML's logging.eval_batch_size went into the sink,
    # not the persisted PDConfig. Default to the training batch_size for this sweep.
