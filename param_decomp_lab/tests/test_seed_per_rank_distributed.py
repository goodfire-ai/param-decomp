...
1. Directly with torchrun (fastest):
   torchrun --standalone --nproc_per_node=2 --master_port=29505 param_decomp/tests/test_seed_per_rank_distributed.py

2. Via pytest (runs torchrun in subprocess):
   pytest param_decomp/tests/test_seed_per_rank_distributed.py
"""
