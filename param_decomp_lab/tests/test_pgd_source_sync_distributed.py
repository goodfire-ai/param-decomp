...
1. Directly with torchrun (fastest):
   torchrun --standalone --nproc_per_node=2 --master_port=29504 param_decomp/tests/test_pgd_source_sync_distributed.py

2. Via pytest (runs torchrun in subprocess):
   pytest param_decomp/tests/test_pgd_source_sync_distributed.py
"""
