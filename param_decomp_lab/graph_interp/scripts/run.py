...
Called by SLURM or directly:
    python -m param_decomp_lab.graph_interp.scripts.run <decomposition_id> --config_json '{...}'
"""
...
from param_decomp_lab.graph_interp.schemas import get_graph_interp_subrun_dir
...
def get_command(
    ...
    return (
        "python -m param_decomp_lab.graph_interp.scripts.run "
