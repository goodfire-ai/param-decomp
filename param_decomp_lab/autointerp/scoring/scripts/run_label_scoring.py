...
Usage:
    python -m param_decomp_lab.autointerp.scoring.scripts.run_label_scoring <decomposition_id> --config_json '...' --harvest_subrun_id h-20260211_120000
"""
...
from param_decomp_lab.autointerp.config import AutointerpEvalConfig
from param_decomp_lab.autointerp.db import InterpDB
from param_decomp_lab.autointerp.repo import InterpRepo
from param_decomp_lab.autointerp.scoring.detection import run_detection_scoring
from param_decomp_lab.autointerp.scoring.fuzzing import run_fuzzing_scoring
...
def get_command(
    ...
    cmd = (
        f"python -m param_decomp_lab.autointerp.scoring.scripts.run_label_scoring "
