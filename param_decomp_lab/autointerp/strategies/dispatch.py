...
from param_decomp_lab.autointerp.strategies.compact_skeptical import (
    format_prompt as compact_skeptical_prompt,
)
from param_decomp_lab.autointerp.strategies.dual_view import (
    format_prompt as dual_view_prompt,
)
from param_decomp_lab.autointerp.strategies.rich_examples import (
