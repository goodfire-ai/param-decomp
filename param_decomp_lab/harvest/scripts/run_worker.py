...
Usage:
    python -m param_decomp_lab.harvest.scripts.run_worker --config_json '{"n_batches": 100}'
    python -m param_decomp_lab.harvest.scripts.run_worker --config_json '...' --rank 0 --world_size 4 --subrun_id h-20260211_120000
"""
