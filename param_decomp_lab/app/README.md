...
```bash
# Backend
python -m param_decomp_lab.app.run_app  # also starts frontend; pass --no-frontend for backend-only

# Frontend
cd param_decomp_lab/app/frontend && npm run dev
```

## Project Structure

```
param_decomp_lab/app/
