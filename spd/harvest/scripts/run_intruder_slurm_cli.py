...
Usage:
    spd-intruder <decomposition_id> <harvest_subrun_id>
    spd-intruder <decomposition_id> <harvest_subrun_id> --config intruder_config.yaml
"""
...
def main(
    ...
    from spd.harvest.scripts.run_intruder_slurm import submit_intruder
