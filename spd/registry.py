...
EXPERIMENT_REGISTRY: dict[str, ExperimentConfig] = {
    ...
    "pile_4L_fs_C_0.5x": ExperimentConfig(
        task_name="lm",
        decomp_script=Path("spd/experiments/lm/lm_decomposition.py"),
        config_path=Path("spd/experiments/lm/pile_4L_fs_C_0.5x.yaml"),
        expected_runtime=1440,
    ),
    "pile_4L_fs_C_2x": ExperimentConfig(
        task_name="lm",
        decomp_script=Path("spd/experiments/lm/lm_decomposition.py"),
        config_path=Path("spd/experiments/lm/pile_4L_fs_C_2x.yaml"),
        expected_runtime=1440,
    ),
    "pile_4L_fs_C_4x": ExperimentConfig(
        task_name="lm",
        decomp_script=Path("spd/experiments/lm/lm_decomposition.py"),
        config_path=Path("spd/experiments/lm/pile_4L_fs_C_4x.yaml"),
        expected_runtime=1440,
    ),
    "pile_4L_fs_impmin_0.5x": ExperimentConfig(
        task_name="lm",
        decomp_script=Path("spd/experiments/lm/lm_decomposition.py"),
        config_path=Path("spd/experiments/lm/pile_4L_fs_impmin_0.5x.yaml"),
        expected_runtime=1440,
    ),
    "pile_4L_fs_impmin_2x": ExperimentConfig(
        task_name="lm",
        decomp_script=Path("spd/experiments/lm/lm_decomposition.py"),
        config_path=Path("spd/experiments/lm/pile_4L_fs_impmin_2x.yaml"),
        expected_runtime=1440,
    ),
    "pile_4L_fs_impmin_4x": ExperimentConfig(
        task_name="lm",
        decomp_script=Path("spd/experiments/lm/lm_decomposition.py"),
        config_path=Path("spd/experiments/lm/pile_4L_fs_impmin_4x.yaml"),
        expected_runtime=1440,
    ),
    "pile_4L_fs_beta_0": ExperimentConfig(
        task_name="lm",
        decomp_script=Path("spd/experiments/lm/lm_decomposition.py"),
        config_path=Path("spd/experiments/lm/pile_4L_fs_beta_0.yaml"),
        expected_runtime=1440,
    ),
    "pile_4L_fs_beta_2x": ExperimentConfig(
        task_name="lm",
        decomp_script=Path("spd/experiments/lm/lm_decomposition.py"),
        config_path=Path("spd/experiments/lm/pile_4L_fs_beta_2x.yaml"),
        expected_runtime=1440,
    ),
    "pile_4L_fs_beta_4x": ExperimentConfig(
        task_name="lm",
        decomp_script=Path("spd/experiments/lm/lm_decomposition.py"),
        config_path=Path("spd/experiments/lm/pile_4L_fs_beta_4x.yaml"),
        expected_runtime=1440,
    ),
